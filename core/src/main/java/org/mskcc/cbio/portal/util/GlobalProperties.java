...
public class GlobalProperties {
    ...
    public static final String PATIENT_VIEW_INTERNAL_SLIDE_IMAGES_ROOT = "patient_view.internal_slide_images_root";
    ...
    public static String getInternalSlideImagesRoot()
    {
    	return properties.getProperty(PATIENT_VIEW_INTERNAL_SLIDE_IMAGES_ROOT);
    }
