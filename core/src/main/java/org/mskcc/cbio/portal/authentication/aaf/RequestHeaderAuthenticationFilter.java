...
/**
 * A modification of the springframework RequestHeaderAuthenticationFilter which obtains the
 * username as a parameter from the request and not specifically from the request header.  
 * <p>
...
public class RequestHeaderAuthenticationFilter extends AbstractPreAuthenticatedProcessingFilter {
    // ToDo: update variable names to reference paramnot header 
    ...
    protected Object getPreAuthenticatedPrincipal(HttpServletRequest request) {
        String principal = request.getParam(principalRequestHeader);
    ...
    protected Object getPreAuthenticatedCredentials(HttpServletRequest request) {
        if (credentialsRequestHeader != null) {
            return request.getParam(credentialsRequestHeader);
        }
