<object data="<%=ca125ReportUrl%>" type="application/pdf" width="100%" height="600px">
 
  <p>It appears you don't have a PDF plugin for this browser.</p>
  <p id="missing-pdf-plugin">You can <a href="<%=ca125ReportUrl%>">click here to
...
$(document).ready(function(){
    if (cbio.util.browser.mozilla) { // firefox
        var msg = "You can <ul><li>either install a PDF plugin such as <a href='https://addons.mozilla.org/en-US/firefox/addon/pdfjs/'>this one</a> and refresh this page,</li>\n\
                   <li>or <a href='<%=ca125ReportUrl%>'>click here to download the pathology report PDF file</a>.</li></ul>";
